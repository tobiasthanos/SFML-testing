...
/** Editor widget
 */
class SFGUI_API Editor : public Widget {
	public:
		typedef SharedPtr<Editor> Ptr; //!< Shared pointer.
		typedef SharedPtr<const Editor> PtrConst; //!< Shared pointer.
	...
	private:
		...
		// Data structures holding the total content of the Editor and the visible portion of it
		sf::String m_string;
